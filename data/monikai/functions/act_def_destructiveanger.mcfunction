execute at @e[name=Monika_] run fill ~1 ~1 ~1 ~-1 ~-1 ~-1 air replace #minecraft:doors
execute at @e[name=Monika_] run fill ~1 ~1 ~1 ~-1 ~-1 ~-1 air replace #minecraft:fences
execute at @e[name=Monika_] run fill ~1 ~1 ~1 ~-1 ~-1 ~-1 air replace iron_bars
